  ...
  implements ProductCategoryDao
{
  public List<ProductCategory> findRoots(Integer count)
  {
    ...
    TypedQuery localTypedQuery = this.IIIllIlI.createQuery(str, ProductCategory.class).setFlushMode(FlushModeType.COMMIT);
    if (count != null)
  ...
  public List<ProductCategory> findParents(ProductCategory productCategory, Integer count)
  {
    ...
    TypedQuery localTypedQuery = this.IIIllIlI.createQuery(str, ProductCategory.class).setFlushMode(FlushModeType.COMMIT).setParameter("ids", productCategory.getTreePaths());
    if (count != null)
      localTypedQuery.setMaxResults(count.intValue());
    return localTypedQuery.getResultList();
  }
  ...
  public List<ProductCategory> findChildren(ProductCategory productCategory, Integer count)
  {
    ...
    if (productCategory != null)
    {
      ...
      localTypedQuery = this.IIIllIlI.createQuery(str, ProductCategory.class).setFlushMode(FlushModeType.COMMIT).setParameter("treePath", "%," + productCategory.getId() + "," + "%");
    }
    else
    {
      str = "select productCategory from ProductCategory productCategory order by productCategory.order asc";
      localTypedQuery = this.IIIllIlI.createQuery(str, ProductCategory.class).setFlushMode(FlushModeType.COMMIT);
    }
    if (count != null)
      localTypedQuery.setMaxResults(count.intValue());
  ...
  public void remove(ProductCategory productCategory)
  {
    if (productCategory != null)
    {
      ...
      this.IIIllIlI.createQuery(localStringBuffer.toString()).setFlushMode(FlushModeType.COMMIT).setParameter("productCategory", productCategory).executeUpdate();
      super.remove(productCategory);
    }
  }

  private List<ProductCategory> IIIllIlI(List<ProductCategory> paramList, ProductCategory paramProductCategory)
  {
    ...
    if (paramList != null)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if (localProductCategory.getParent() == paramProductCategory)
        {
          ...
          localArrayList.addAll(IIIllIlI(paramList, localProductCategory));
        }
      }
    }
  ...
  private void IIIllIlI(ProductCategory paramProductCategory)
  {
    ...
    if (localProductCategory != null)
      paramProductCategory.setTreePath(localProductCategory.getTreePath() + localProductCategory.getId() + ",");
    else
