  ...
  implements TemplateMethodModel
{
  ...
  public Object exec(List arguments)
  {
    if ((arguments != null) && (!arguments.isEmpty()) && (arguments.get(0) != null) && (StringUtils.isNotEmpty(arguments.get(0).toString())))
    {
      ...
      return new SimpleScalar(IIIllIlI(arguments.get(0).toString(), localInteger, str));
    }
    return null;
  }

  private String IIIllIlI(String paramString1, Integer paramInteger, String paramString2)
  {
    if (paramInteger != null)
    {
      ...
      {
        j = IIIllIlI.matcher(String.valueOf(paramString1.charAt(i))).find() ? j + 2 : j + 1;
 ...
 * Qualified Name:     net.shopxx.template.method.AbbreviateMethod
